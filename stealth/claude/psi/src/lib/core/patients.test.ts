...
describe('validateRelative', () => {
	...
	it('returns true with optional phone/email present', () => {
		expect(
			validateRelative({ name: 'Jane', relation: 'mother', phone: '11999990000', email: 'j@ex.com' })
		).toBe(true);
	});
...
const PATIENTS: Patient[] = [
	makeSearchPatient({ id: 'p1', name: 'Alice Smith', email: 'alice@example.com', phone: '11999990001' }),
	makeSearchPatient({ id: 'p2', name: 'Bob Jones', email: 'bob@example.com', phone: '11999990002' }),
	makeSearchPatient({ id: 'p3', name: 'Carlos Souza', email: null, phone: null })
];
